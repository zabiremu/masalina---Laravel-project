                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="{{ ($route == 'aboutPage') ? 'active' : ''  }}"><a href="{{ route('aboutPage') }}">About</a></li>

                                    <li class="menu-item-has-children {{ ($route == 'portfolio.all') ? 'active' : ''  }}"><a href="{{ route('portfolio.all') }}">Portfolio</a>
                                    </li>
                                    <li class="menu-item-has-children {{ ($route == 'all.blogs') ? 'active' : ''  }}"><a href="{{ route('all.blogs') }}">Our Blog</a>
                                    </li>
