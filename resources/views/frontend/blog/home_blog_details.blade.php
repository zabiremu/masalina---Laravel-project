            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{ $blogData->blog_title }}</h2>
                ...
                <div class="col-lg-8">
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <img src="{{ url($blogData->blog_image_url) }}" alt="">
                        </div>
                        <div class="blog__details__content services__details__content">
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i>
                                    {{ Carbon\Carbon::parse($blogData->created_at)->diffForHumans() }}</li>
                            </ul>
                            <h2 class="title">{{ $blogData->blog_title }}</h2>
                            <p>{!! $blogData->blog_details !!}</p>
                            ...
                            <ul class="sidebar__cat">
                                @foreach ($category as $item)
                                    <li class="sidebar__cat__item"><a
                                            href="{{ route('blog.cat', $item->id) }}">{{ $item->blog_category }}</a></li>
                                @endforeach
                            </ul>
                        </div>
