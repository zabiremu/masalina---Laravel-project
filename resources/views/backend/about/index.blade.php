    ...
    <div class="col-md-12 grid-margin stretch-card mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('about.update') }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="name" placeholder="Tile" name="name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="shortTitle" placeholder="Short Title"
                                name="shortTitle" value="{{ $data->short_title }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" class="form-control" rows="8" id="shortDesc" placeholder="Short Description"
                                name="shortDesc" required>{{ $data->short_dscription }}</textarea>
                        </div>
                    </div>


                    <div class="form-group row">
                        <label for="shortDesc" class="col-sm-3 col-form-label">Long Description</label>
                        <div class="col-sm-9">
                            <textarea id="summernote" name="editordata">{{ $data->long_dscription }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img src="{{ !empty($data->image) ? $data->image_uri : asset('backend/assets/images/Placeholder_view_vector.svg.png') }}"
