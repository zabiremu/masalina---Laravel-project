    ...
    <div class="col-md-12 grid-margin stretch-card mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('about.multi.image') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="file" class="form-control" id="image" name="about_image[]" multiple required>
                        </div>
                    </div>
