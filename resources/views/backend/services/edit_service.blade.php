...
@section('content')
    ...
    <div class="col-md-12 grid-margin stretch-card mt-5">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Eidt Service</h4>
                <form class="forms-sample" action="{{ route('service.update', $data->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="shortTitle" placeholder="Short Title"
                                name="shortTitle" value="{{ $data->shot_title }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea id="summernote" name="description" required>{{ $data->details }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img src="{{ ($data->image_url) ? url($data->image_url) : asset('backend/assets/images/Placeholder_view_vector.svg.png') }}"
