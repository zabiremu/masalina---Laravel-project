    ...
    <div class="col-md-12 grid-margin stretch-card mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('portfolio.update',$data->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea id="summernote" name="editordata" required>{{ $data->short_details }}</textarea>
                        </div>
                    </div>


                    <div class="form-group row">
                        <label for="image" class="col-sm-3 col-form-label">Portfolio Image</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img src="{{ !empty($data->image) ? url($data->image_url) : asset('backend/assets/images/Placeholder_view_vector.svg.png') }}"
