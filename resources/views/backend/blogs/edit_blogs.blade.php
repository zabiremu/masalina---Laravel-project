            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('update.blog', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-9">
                            <select name="categroy" class="form-control">
                                ...
                                @foreach ($category as $cat)
                                    <option value="{{ $cat->id }}" {{ $cat->id == $blog->blog_category_id ? 'selected' : ''}}>
                                        {{ $cat->blog_category }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="name" placeholder="Tile" name="title"
                                required value="{{ $blog->blog_title }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea id="summernote" name="description">{{ $blog->blog_details }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tags" value="Laravel, React" name="tags"
                                data-role="tagsinput" value="{{ $blog->blog_tags }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img src="{{ $blog->blog_image ? url($blog->blog_image_url) : asset('backend/assets/images/Placeholder_view_vector.svg.png') }}"
